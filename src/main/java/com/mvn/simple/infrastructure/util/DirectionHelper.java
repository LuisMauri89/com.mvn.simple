...
public class DirectionHelper {
	...
	/*
	 * Will return the new direction based on current direction and turn action.
	 */
	public static Direction nextDirection(final Action turn, final Direction direction) {
		List<Direction> directions = Arrays.asList(Direction.WEST, Direction.NORTH, Direction.EAST, Direction.SOUTH);
